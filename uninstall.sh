...
$SUDO rm -f /usr/local/bin/fdm /usr/local/bin/fdm-update /usr/local/bin/fdm-doctor /usr/local/bin/fdm-dl /usr/local/bin/fdm-video
$SUDO rm -f /usr/share/bash-completion/completions/fdm /usr/share/bash-completion/completions/fdm-update /usr/share/bash-completion/completions/fdm-doctor /usr/share/bash-completion/completions/fdm-dl /usr/share/bash-completion/completions/fdm-video 2>/dev/null || true
