...
run_doctor() {
    ...
    echo -e "  ${GREEN}✔ Diagnosis: 100% Healthy!${NC}"
    echo -e "  ${DIM}Your Fedora setup is cleaner than a brand new ThinkPad out of the box! 🧼✨${NC}"
    echo ""
...
CORE_DEPS="binutils curl desktop-file-utils xdg-utils bubblewrap libxcb libxkbcommon-x11 libnotify yt-dlp nodejs python3-secretstorage python3-cryptography"
...
echo -e "${GREEN}${BOLD}└──────────────────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "${CYAN}💡 Pro Tip:${NC} ${BOLD}Your internet download speed has officially increased by 420%${NC} ${DIM}(Source: Trust me bro)${NC} 🏎️💨"
echo -e "${DIM}   Ready to download 100% legal Linux ISOs at lightspeed! 🐧🛸${NC}"
echo ""
